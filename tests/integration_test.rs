...
async fn query_response_edns(domain_name: &str, protocol: &str, qtype: &str, max_payload: Option<u16>, version: u16, flags: u16, option: Option<Vec<u16>>) -> Result<Vec<ResourceRecord>, ClientError> {
